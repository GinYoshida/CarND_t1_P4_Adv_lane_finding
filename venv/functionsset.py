...
def create_binary_img(img):
    ...
    #
    pts1 = np.float32([[570, 450], [0, 720], [1280, 720], [710, 450]])
    pts2 = np.float32([[200, 0], [200, 720], [1080, 720], [1080, 0]])
...
def lane_writer(warped, window_width = 50,window_height = 80,margin = 100):
...
def image_pal_calculatn(img, left_lane, right_lane, lane_thickness = 5):
    ...
    right_radius  = ((1 + (2*left_fit_cr[0]*y_eval*ym_per_pix + left_fit_cr[1])**2)**1.5) / np.absolute(2*left_fit_cr[0])
